...
export default function PricingPage() {
        ...
        <div className="max-w-[1600px] mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center border-b border-[#2F5D73] py-6 sm:py-8 gap-2">
            ...
            <span className="text-2xl sm:text-4xl md:text-6xl font-bold text-[#2F5D73]">+₱150</span>
                  ...
                  {/* FOOTER CONTENT */}
      <div className="border-t border-[#2F5D73] mt-2 pt-10 pb-10">
  ...
  <div>
    ...
    <p className="mt-6 text-sm text-[#2F5D73] ">
      200 N. SPRING STREET LOS ANGELES <br /> CA 90012 UNITED STATES
    </p>
    ...
    <p className="mt-6 text-sm text-[#2F5D73] ">
      EMALF@GMAIL.COM
        ...
        {/* Footer bottom */}
        <div className="border-t border-[#2F5D73] mt-9"></div>
       
        <div className="max-w-8xl mx-auto px-12 mt-6 flex justify-between text-[#2F5D73]">
